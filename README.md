# Smart Password Manager Desktop <sup>v4.0.3</sup>
...
## 🔄 Breaking Change (v4.0.3)

> **⚠️ This release uses [smartpasslib](https://github.com/smartlegionlab/smartpasslib) v4.0.3, which is NOT backward compatible with v2.x.x or v3.x.x**
...
**Legacy Migration**:
- Old `~/.cases.json` files from v1.x.x/v2.x.x/v3.x.x are **NOT compatible** with v4.0.3
...
3. **Case-sensitive** - v4.0.3 enforces exact case matching
