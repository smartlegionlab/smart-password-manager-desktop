# Migration Guide: v2.x.x / v3.x.x to v4.0.4

> **📌 Version Note:** Smart Password Manager Desktop v4.0.4 uses smartpasslib v4.0.0, which introduces breaking changes from all previous versions. All smartpasslib implementations (Python, C#, JS, Go, Kotlin) now share the same algorithm.

## ⚠️ Breaking Change Notice

**Smart Password Manager Desktop v4.0.4 is NOT backward compatible with v2.x.x or v3.x.x**
...
| **v4.0.4** | **v4.0.0**   | ✅ Current    | Dynamic steps (15-30/45-60), expanded charset, max security |

Smart passwords generated with older versions will be different when generated with v4.0.4 due to fundamental changes in the deterministic generation algorithm.

---

## Why the change?

**Desktop Manager v4.0.4 (smartpasslib v4.0.0) introduces fundamental improvements:**
...
**The old `passwords.json` file is NOT compatible with v4.0.4**

Public keys stored in v2.x.x/v3.x.x files cannot be used with v4.0.4 because:
...
### Step 3: Upgrade to v4.0.4

Update the application to the latest version.

### Step 4: Remove old metadata file

The old metadata file must be removed or moved away from the default location. v4.0.4 will create a new empty file on first run.
...
First migrate to v3.x.x following the old migration guide, then to v4.0.4.
